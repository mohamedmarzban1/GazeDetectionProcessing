...
HAT_BACK="output/D2019-10-31/ContGaze/AprilHatContGaze.csv"
AprilTag_Calib_Back="output/D2019-10-31/ContGaze/AprilCalibContGaze.csv"
...
echo "Calibrating continuous gaze"
python3 apriltags/scripts/Calibration.py "$AprilTag_Calib_Back" "$Ref_Calib_Back" "$KabaschRotTrans"  & 
