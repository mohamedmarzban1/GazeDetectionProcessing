...
def Calibration(backCalibAprilFile, refCalibFile, KabaschRotTrans, OutDoorTagID=300, noRotationFlag=0):    
    import csv
    import numpy as np
    import pickle
    import rmsd
...
#KabaschRotTrans = "C:/Users/mfm160330/OneDrive - The University of Texas at Dallas/ADAS data/OutputFiles/D2019-7-23/FixedGaze/KabaschRotTransTestNoCorners.pickle"   #"../../output/KabaschRotTransCont.pickle"
    ...
    index3 = np.argwhere(TagIDs == OutDoorTagID)
    ...
    print("detected IDs in current coordinates = ",TagIDs_c)
    print("x = ",xAvgCurrent)
    print("y = ",yAvgCurrent)
    print("z= ",zAvgCurrent)
    ...
    assert (XYZref.size > 0), "Error: Less than 3 common calibration tags detected. Repeat calibration"
    assert (XYZcurrent.size > 0), "Error: Less than 3 common calibration tags detected. Repeat calibration"
    ...
    pickle_out.close()
    print("Written to ",KabaschRotTrans)
    print('=========End of calibration =================')

##### REMOVE ME ###
#print("COmment me===================")
#Calibration("/media/sf_UbuntuWinShare/2020-02-22-001/FixedGaze/AprilHatFixedGaze.csv", "/home/marzban/calibrateCameras/naofal-lab/config/BackMarkers2019-6-20CornersSorted.pickle", "/media/sf_UbuntuWinShare/2020-02-22-001/FixedGaze/KabaschRotTransTEST.pickle")
