...
#backCalibAprilFile = "../../output/D2019-10-30/ContGaze/AprilCalibContGaze.csv"
#refCalibFile = "../../config/MarkersAppended2019-6-20BackStandard.pickle"
...
TagIDs = np.delete(TagIDs, index3) # remove the calibration tags in the car
...
for i1 in range(len(TagIDs)):
    ...
    index3 = np.argwhere(hamDistErrsIncluded > 1) 
