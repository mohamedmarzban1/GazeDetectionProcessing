...
def sync_back_and_visualize(visualize_path, back_path, visualize_frames):
    ...
    while row_counter < data_rows and frame_counter < frames:
        ...
        if detectionID == 2222:
            ...
            vis_row[0], vis_row[1], vis_row[2] = -vis_row[2], -vis_row[0], vis_row[1]
...
def main():
    ...
    visualize_frames = open('output/visualize_frames_Coord.csv', 'w+') 
    #sync_back_and_visualize(args.visualize, args.back, visualize_frames)
    sync_back_and_visualize(args.visualize, "../../output/AprilTag_Hat.csv", "../../visualize_2/meshsave_back_2.mat")
